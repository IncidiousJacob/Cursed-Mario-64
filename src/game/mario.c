...
if (isClimbingPole && !sWasClimbingPole) {
    ...
    if (gCurrLevelNum == LEVEL_CASTLE_GROUNDS) {
        ...
        if (mx > -2150 && mx < -1650 &&
            my > 218 && my < 818 &&
            mz > 2618 && mz < 3118)
            if (!SM64AP_CheckedLoc(5800)) SM64AP_SendItem(5800);

        // --- Tree 5801 ---
        if (mx > -2816 && mx < -2316 &&
            my > 169 && my < 769 &&
            mz > 2376 && mz < 2876)
            if (!SM64AP_CheckedLoc(5801)) SM64AP_SendItem(5801);

        // --- Tree 5802 ---
        if (mx > -2271 && mx < -1771 &&
            my > 426 && my < 1026 &&
            mz > 1218 && mz < 1718)
            if (!SM64AP_CheckedLoc(5802)) SM64AP_SendItem(5802);

        // --- Tree 5803 ---
        if (mx > -1583 && mx < -1083 &&
            my > 541 && my < 1141 &&
            mz > 1631 && mz < 2131)
            if (!SM64AP_CheckedLoc(5803)) SM64AP_SendItem(5803);

        // --- Tree 5804 ---
        if (mx > -359 && mx < 141 &&
            my > 507 && my < 1107 &&
            mz > 2758 && mz < 3258)
            if (!SM64AP_CheckedLoc(5804)) SM64AP_SendItem(5804);

        // --- Tree 5805 ---
        if (mx > -5319 && mx < -4819 &&
            my > 134 && my < 734 &&
            mz > 2971 && mz < 3471)
            if (!SM64AP_CheckedLoc(5805)) SM64AP_SendItem(5805);

        // --- Tree 5806 ---
        if (mx > -6470 && mx < -5970 &&
            my > 202 && my < 802 &&
            mz > 3208 && mz < 3708)
            if (!SM64AP_CheckedLoc(5806)) SM64AP_SendItem(5806);

        // --- Tree 5807 ---
        if (mx > -6760 && mx < -6260 &&
            my > 93 && my < 693 &&
            mz > 1161 && mz < 1661)
            if (!SM64AP_CheckedLoc(5807)) SM64AP_SendItem(5807);

        // --- Tree 5808 ---
        if (mx > -5454 && mx < -4954 &&
            my > 38 && my < 638 &&
            mz > 561 && mz < 1061)
            if (!SM64AP_CheckedLoc(5808)) SM64AP_SendItem(5808);

        // --- Tree 5809 ---
        if (mx > -4961 && mx < -4461 &&
            my > 197 && my < 797 &&
            mz > 183 && mz < 683)
            if (!SM64AP_CheckedLoc(5809)) SM64AP_SendItem(5809);

        // --- Tree 5810 ---
        if (mx > -5756 && mx < -5256 &&
            my > 240 && my < 840 &&
            mz > -911 && mz < -411)
            if (!SM64AP_CheckedLoc(5810)) SM64AP_SendItem(5810);

        // --- Tree 5811 ---
        if (mx > -6519 && mx < -6019 &&
            my > 202 && my < 802 &&
            mz > -2395 && mz < -1895)
            if (!SM64AP_CheckedLoc(5811)) SM64AP_SendItem(5811);

        // --- Tree 5812 ---
        if (mx > -5850 && mx < -5350 &&
            my > 191 && my < 791 &&
            mz > -2877 && mz < -2377)
            if (!SM64AP_CheckedLoc(5812)) SM64AP_SendItem(5812);

        // --- Tree 5813 ---
        if (mx > -6207 && mx < -5707 &&
            my > 359 && my < 959 &&
            mz > -3697 && mz < -3197)
            if (!SM64AP_CheckedLoc(5813)) SM64AP_SendItem(5813);

        // --- Tree 5814 ---
        if (mx > 517 && mx < 1017 &&
            my > 330 && my < 930 &&
            mz > 2348 && mz < 2848)
            if (!SM64AP_CheckedLoc(5814)) SM64AP_SendItem(5814);

        // --- Tree 5815 ---
        if (mx > 517 && mx < 1017 &&
            my > 330 && my < 930 &&
            mz > 2348 && mz < 2848)
            if (!SM64AP_CheckedLoc(5815)) SM64AP_SendItem(5815);

        // --- Tree 5816 ---
        if (mx > 882 && mx < 1382 &&
            my > 202 && my < 802 &&
            mz > 882 && mz < 1382)
            if (!SM64AP_CheckedLoc(5816)) SM64AP_SendItem(5816);

        // --- Tree 5817 ---
        if (mx > 1669 && mx < 2169 &&
            my > 30 && my < 630 &&
            mz > 907 && mz < 1407)
            if (!SM64AP_CheckedLoc(5817)) SM64AP_SendItem(5817);

        // --- Tree 5818 ---
        if (mx > 2903 && mx < 3403 &&
            my > -53 && my < 547 &&
            mz > 219 && mz < 719)
            if (!SM64AP_CheckedLoc(5818)) SM64AP_SendItem(5818);

        // --- Tree 5819 ---
        if (mx > 5928 && mx < 6428 &&
            my > -7 && my < 593 &&
            mz > -83 && mz < 417)
            if (!SM64AP_CheckedLoc(5819)) SM64AP_SendItem(5819);

        // --- Tree 5820 ---
        if (mx > 5524 && mx < 6024 &&
            my > 173 && my < 773 &&
            mz > -1364 && mz < -864)
            if (!SM64AP_CheckedLoc(5820)) SM64AP_SendItem(5820);

        // --- Tree 5821 ---
        if (mx > 6149 && mx < 6649 &&
            my > 247 && my < 847 &&
            mz > -1930 && mz < -1430)
            if (!SM64AP_CheckedLoc(5821)) SM64AP_SendItem(5821);

        // --- Tree 5822 ---
        if (mx > 5704 && mx < 6204 &&
            my > 266 && my < 866 &&
            mz > -3096 && mz < -2596)
            if (!SM64AP_CheckedLoc(5822)) SM64AP_SendItem(5822);

        // --- Tree 5823 ---
        if (mx > 5207 && mx < 5707 &&
            my > 284 && my < 884 &&
            mz > -3509 && mz < -3009)
            if (!SM64AP_CheckedLoc(5823)) SM64AP_SendItem(5823);

        // --- Tree 5824 ---
        if (mx > 5618 && mx < 6118 &&
            my > 425 && my < 1025 &&
            mz > -4703 && mz < -4203)
            if (!SM64AP_CheckedLoc(5824)) SM64AP_SendItem(5824);

        // --- Tree 5825 ---
        if (mx > 6158 && mx < 6658 &&
            my > 637 && my < 1237 &&
            mz > -5564 && mz < -5064)
            if (!SM64AP_CheckedLoc(5825)) SM64AP_SendItem(5825);
    }
