...
// 0x06038C38
static Lights1 bowser_seg6_lights_06038C38 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

static void sm64ap_set_bowser_light_group(Lights1 *dst, u8 r, u8 g, u8 b) {
    dst->a.l.col[0] = r / 2;
    dst->a.l.col[1] = g / 2;
    dst->a.l.col[2] = b / 2;
...
void SM64AP_ApplyBowserPalette(void) {
    sm64ap_set_bowser_light_group(&bowser_seg6_lights_06038C38,
        gBowserBodyColor.r,
        gBowserBodyColor.g,
        gBowserBodyColor.b);
}
